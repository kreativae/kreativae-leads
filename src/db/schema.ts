...
export const leads = pgTable(
  "leads",
  {
    ...
    notes: text("notes"),
    // Automacao (Abordagem pronta disparada por WhatsApp ou e-mail): estes
    // 3 campos so registram o resultado mais recente pra exibir no proprio
    // lead; o historico completo fica no system_logs.
